...
def main(args=None):
    ...
    velocity_publisher = teleop.create_publisher(geometry_msgs.msg.Twist, f'/{namespace}/offboard_velocity_cmd', qos_profile)
    arm_publisher = teleop.create_publisher(std_msgs.msg.Bool, f'/{namespace}/arm_message', qos_profile)
